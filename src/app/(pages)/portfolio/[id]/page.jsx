...
const ProjectDeatails = async ({ params }) => {
  ...
  if (!data?.success) {
    return (
      <InfoMessage
        message={
          data?.message || "Not available right now. Please try again later."
        }
      />
    );
  }
          ...
          <div className="lg:flex items-start justify-evenly gap-4 my-10">
            <div className="my-5 flex-1">
              ...
              <p>
                ...
                software, allowing you to visualise your custom media wall
                before it's built. Visit our showroom to explore a wide range of
                material samples, which you're welcome to take home and try in
                your own space.
              </p>
