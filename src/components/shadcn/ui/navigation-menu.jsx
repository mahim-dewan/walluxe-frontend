...
function NavigationMenu({
  ...
  return (
    ...
    >
      {children}
      {viewport && <NavigationMenuViewport viewPortClass={viewPortClass} />}
    </NavigationMenuPrimitive.Root>
  );
}
...
function NavigationMenuViewport({ className, viewPortClass, ...props }) {
  return (
    <div
      className={cn(
        "absolute top-full left-10 isolate z-50 flex justify-center",
        viewPortClass
      )}
    >
